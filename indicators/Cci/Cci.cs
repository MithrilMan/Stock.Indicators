...
namespace Skender.Stock.Indicators
{
    public static partial class Indicator
    {
        ...
        public static IEnumerable<CciResult> GetCci(IEnumerable<IQuote> history, int lookbackPeriod = 20)
        {
        ...
        private static void ValidateCci(IEnumerable<IQuote> history, int lookbackPeriod)
        {
