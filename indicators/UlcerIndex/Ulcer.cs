...
namespace Skender.Stock.Indicators
{
    ...
    {
        // ULCER INDEX (UI)
        public static IEnumerable<UlcerIndexResult> GetUlcerIndex(IEnumerable<IQuote> history, int lookbackPeriod = 14)
        {
        ...
        private static void ValidateUlcer(IEnumerable<IQuote> history, int lookbackPeriod)
        {
