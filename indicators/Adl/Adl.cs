...
namespace Skender.Stock.Indicators
{
    public static partial class Indicator
    {
        ...
        public static IEnumerable<AdlResult> GetAdl(IEnumerable<IQuote> history, int? smaPeriod = null)
        {
        ...
        private static void ValidateAdl(IEnumerable<IQuote> history, int? smaPeriod)
        {
