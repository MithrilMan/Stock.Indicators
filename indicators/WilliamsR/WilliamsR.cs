...
namespace Skender.Stock.Indicators
{
    public static partial class Indicator
    {
        ...
        public static IEnumerable<WilliamsResult> GetWilliamsR(IEnumerable<IQuote> history, int lookbackPeriod = 14)
        {
        ...
        private static void ValidateWilliam(IEnumerable<IQuote> history, int lookbackPeriod)
        {
