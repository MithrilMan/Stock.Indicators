...
namespace Skender.Stock.Indicators
{
    public static partial class Indicator
    {
        ...
        public static IEnumerable<SlopeResult> GetSlope(IEnumerable<IQuote> history, int lookbackPeriod)
        {
            // clean quotes
        ...
        private static void ValidateSlope(IEnumerable<IQuote> history, int lookbackPeriod)
        {
